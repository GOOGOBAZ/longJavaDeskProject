...
return;
    ...
    for(Object theLedger:theLedgersToApprove){
         ...
         if(!ancdb.testTable("bsanca"+theLedger.toString())){
              ancdb.activateAccount(theLedger.toString());
...
column1= new ArrayList();
    ...
    private void jComboBoxSubCat4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxSubCat4ActionPerformed
     ...
     jComboBoxSubCat5.setEnabled(true); 
      jComboBoxSubCat5.setVisible(true); 
        ...
        data .add("Equipment & Machinery");
        data .add("Motor Vehicles");
        data .add("Furniture, Fixtures & Fittings");
        data .add("Computer And Electronics");
    ...
    case "Reserves And Surplus":
            data  = new ArrayList<>();
            data .add("Share Premium");
            data .add("Capital Reserve");
            data .add("National Education Fund 2%");
          ...
          case "Other Income":
            ...
            data .add("Dividends");
             ...
             data .add("Loan Surcharge");
              ...
              data .add("Realized Exchange Gain");
...
//            break;
   ...
   jComboBoxSubCat5.setEnabled(false);
    ...
    accountsNumber.setText(ancdb.createAccountNumber(selection3,"10",selection3));
    ...
    if(nSGS==JOptionPane.YES_OPTION){
        ...
        List dataMix  = new ArrayList<>();
          ...
          int d=0;   
             ...
             String accountsNumber=ancdb.createAccountNumber(dataMix.get(d).toString(),"10",dataMix.get(d).toString());    
...
//        f.setUserID(userId);
    ...
    if(nSGS==JOptionPane.YES_OPTION){
        ...
        List accountDetails1  = new ArrayList<>();
    String accountsNumber1=ancdb.createAccountNumber("Gross Interest Income","10","Gross Interest Income");       
