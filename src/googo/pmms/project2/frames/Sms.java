...
this.userId=userid;
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select", "All Customers/Members", "BoardMembers/Staff", " " }));
   ...
   if(jTextArea4.getText().length()>158){
          JOptionPane.showMessageDialog(this, "The message is more than the Allowed 160 characters!!!");
         return;
         }else{
