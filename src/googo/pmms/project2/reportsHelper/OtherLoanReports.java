...
//        JOptionPane.showMessageDialog(c, dataBody.size());
  ...
  public ListDataModel returnOnInvestmentSavings(List dates,Component c) {
        ...
        List< List<Object>> dataBody = new ArrayList();
        int n = 0;
        Map<Integer, List<Object>> dataBase = rdb.savingsIndivROIGrouped(fmt.forDatabaseWithFullYearBeginningWithDate(dates.get(0).toString()), fmt.forDatabaseWithFullYearBeginningWithDate(dates.get(1).toString()),c);
...
//     int n=0; Map<Integer, List<Object>> dataBase=rdb. sharesStatemnt
    ...
    public PdfPTable createActuallyindividualSharesTable(String accountNumber, String sdate, String edate) {
        PdfPTable table = new PdfPTable(5);
        table.setWidthPercentage(100);
        float[] columnWidths = {14f, 25f, 30f, 30f, 30f};
        ...
        PdfPCell cell1 = new PdfPCell(new Paragraph("S/n", font2));
        PdfPCell cell2 = new PdfPCell(new Paragraph("Period", font2));
        PdfPCell cell3 = new PdfPCell(new Paragraph("SavingsRemoved", font2));
        PdfPCell cell4 = new PdfPCell(new Paragraph("SavingsAdded", font2));
        PdfPCell cell5 = new PdfPCell(new Paragraph("TotalSavings", font2));
...
//    }
     ...
     public boolean groupReturnSavingsDaily(String startDate, String endDate, String fileName,Component c) {

        boolean groupROISavingsDaily = false;

        if (fios.exitsFile(fios.createFileName("PMMS_Statements", "PMMS_Statements1", fileName + ".pdf"))) {
            if (fios.deleteFileFirst(fios.createFileName("PMMS_Statements", "PMMS_Statements1", fileName + ".pdf"))) {
                createActuallyGroupROISavingsDailypdf(startDate, endDate, fileName,c);
    ...
    private void createActuallyGroupROISavingsDailypdf(String startDate, String endDate, String fileName,Component c) {
        try {
            ...
            PdfPTable body = createActuallyGroupROISavingsTable(startDate, endDate,c);
    ...
    public PdfPTable createActuallyGroupROISavingsTable( String sdate, String edate,Component c) {
  ...
  cell6.disableBorderSide(LEFT);
      ...
      cell6.disableBorderSide(RIGHT);
       ...
       cell6.setHorizontalAlignment(Element.ALIGN_RIGHT);
        ...
        int n = 0;
        Map<Integer, List<Object>> dataBase = rdb.savingsIndivROIGrouped(sdate, edate,c);
        if (!dataBase.isEmpty()) {
            while (n < dataBase.size()) {
                List realData = dataBase.get(n);
                int z = 0;
