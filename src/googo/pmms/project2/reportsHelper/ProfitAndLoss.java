...
this.userId=userid;
   ...
   public boolean createPAndL(String startDate,String endDate,String fileName) { 
...
createActuallyPandL(startDate,endDate,fileName);
PAndL=true;
  } 
...
PAndL=true;
      ...
      private void createActuallyPandL(String startDate,String endDate,String fileName){
      try {
          ...
          PdfWriter writer=PdfWriter.getInstance(document, fios.FileOutputStream(fios.createFileName("PMMS_Statements", "PMMS_Statements1", fileName+".pdf")));
            body = createTodayPAndL(startDate,endDate);
...
//    cell3.setBorderWidth (2f);
  ...
  return table;
      ...
      public  PdfPTable createTodayPAndL(String startDate,String endDate){
  ...
  i++;
      ...
      Map<Integer, String> level3r=rdb. getLevel3Items("Revenues");
       ...
       Map<Integer, String> level5r=rdb.getLevel5Items("Main Income"); 
        ...
        if(parseDouble(rdb.getBalances(level5r.get(zr),startDate, endDate).get(level5r.get(zr)).toString())!=0.0){
             if(!indReveFirst){
     ...
     cellLeve4r.setColspan(5);
      ...
      double amountr=parseDouble(rdb.getBalances(level5r.get(zr),startDate, endDate).get(level5r.get(zr)).toString());
      if(amountr<0.0){
     ...
     table.addCell(balAmountr);
      ...
      table.addCell(cellEmpty);
       ...
       sumr= sumr+(parseDouble(rdb.getBalances(level5r.get(zr),startDate, endDate).get(level5r.get(zr)).toString()));    
       mainIncome=true;
           }
      ...
      table.addCell(cellEmpty);
       ...
       Map<Integer, String> level5ao=rdb.getLevel5Items("Other Income"); 
        ...
        if(parseDouble(rdb.getBalances(level5ao.get(z1o),startDate, endDate).get(level5ao.get(z1o)).toString())!=0.0){
            if(!indReveFirst){
            PdfPCell cellLeve2r= new PdfPCell(new Paragraph("Revenues",font2));
       cellLeve2r.setColspan(6);
      cellLeve2r.setFixedHeight(16.2f);
     ...
     PdfPCell balAmounto=null;
      double amounto=parseDouble(rdb.getBalances(level5ao.get(z1o),startDate, endDate).get(level5ao.get(z1o)).toString());
      if(amounto<0.0){
      ...
      table.addCell(cellEmpty);
       ...
       sum1o= sum1o+(parseDouble(rdb.getBalances(level5ao.get(z1o),startDate, endDate).get(level5ao.get(z1o)).toString()));   
        z1o++; 
      ...
      table.addCell(cellEmpty);
       ...
       Map<Integer, String> level5ai=rdb.getLevel5Items("Income From Short Term Insurance Business"); 
        ...
        if(parseDouble(rdb.getBalances(level5ai.get(z1i),startDate, endDate).get(level5ai.get(z1i)).toString())!=0.0){
            if(!indReveFirst){
            PdfPCell cellLeve2r= new PdfPCell(new Paragraph("Revenues",font2));
       cellLeve2r.setColspan(6);
      cellLeve2r.setFixedHeight(16.2f);
     ...
     PdfPCell balAmounti=null;
      double amounti=parseDouble(rdb.getBalances(level5ai.get(z1i),startDate, endDate).get(level5ai.get(z1i)).toString());
      if(amounti<0.0){
      ...
      table.addCell(cellEmpty);
       ...
       sum1i= sum1i+(parseDouble(rdb.getBalances(level5ai.get(z1i),startDate, endDate).get(level5ai.get(z1i)).toString()));   
        z1i++; 
    ...
    case "Opening Stock":
       ...
       Map<Integer, String> level5Lr=rdb.getLevel5Items("Opening Stock"); 
        ...
        if(parseDouble(rdb.getBalances(level5Lr.get(zLr),startDate, endDate).get(level5Lr.get(zLr)).toString())!=0.0){
            if(!indExpe){
     ...
     cellLeve4Lr.setColspan(5);
      ...
      double amountLr=parseDouble(rdb.getBalances(level5Lr.get(zLr),startDate, endDate).get(level5Lr.get(zLr)).toString());
      if(amountLr<0.0){
     ...
     table.addCell(balAmountLr);
      ...
      table.addCell(cellEmpty);
       ...
       sumLr= sumLr+(parseDouble(rdb.getBalances(level5Lr.get(zLr),startDate, endDate).get(level5Lr.get(zLr)).toString()));     
       openingStock=true; 
        }
     ...
     table.addCell(cellEmpty);
      ...
      int z1Lp=0; double sum1Lp=0.0; boolean indExpe24=false;
        ...
        if(parseDouble(rdb.getBalances(level5aLp.get(z1Lp),startDate, endDate).get(level5aLp.get(z1Lp)).toString())!=0.0){
           if(!indExpe){
           PdfPCell cellLeve2Lr= new PdfPCell(new Paragraph("Expenses",font2));
       cellLeve2Lr.setColspan(6);
      cellLeve2Lr.setFixedHeight(16.2f);
     ...
     PdfPCell balAmountLp=null;
      double amountLp=parseDouble(rdb.getBalances(level5aLp.get(z1Lp),startDate, endDate).get(level5aLp.get(z1Lp)).toString());
      if(amountLp<0.0){
      ...
      table.addCell(cellEmpty);
       ...
       sum1Lp= sum1Lp+(parseDouble(rdb.getBalances(level5aLp.get(z1Lp),startDate, endDate).get(level5aLp.get(z1Lp)).toString()));   
     ...
     table.addCell(cellEmpty);
       ...
       Map<Integer, String> level5aLdcr=rdb.getLevel5Items("Other Direct Costs"); 
        ...
        if(parseDouble(rdb.getBalances(level5aLdcr.get(z1Ldcr),startDate, endDate).get(level5aLdcr.get(z1Ldcr)).toString())!=0.0){
             if(!indExpe){
           PdfPCell cellLeve2Lr= new PdfPCell(new Paragraph("Expenses",font2));
       cellLeve2Lr.setColspan(6);
      cellLeve2Lr.setFixedHeight(16.2f);
     ...
     PdfPCell balAmountL=null;
      double amountL=parseDouble(rdb.getBalances(level5aLdcr.get(z1Ldcr),startDate, endDate).get(level5aLdcr.get(z1Ldcr)).toString());
      if(amountL<0.0){
      ...
      table.addCell(cellEmpty);
       ...
       sum1Ldcr= sum1Ldcr+(parseDouble(rdb.getBalances(level5aLdcr.get(z1Ldcr),startDate, endDate).get(level5aLdcr.get(z1Ldcr)).toString()));   
     ...
     table.addCell(cellEmpty);
       ...
       Map<Integer, String> level5aLdcs=rdb.getLevel5Items("Factory Overheads"); 
        ...
        if(parseDouble(rdb.getBalances(level5aLdcs.get(z1Ldcs),startDate, endDate).get(level5aLdcs.get(z1Ldcs)).toString())!=0.0){
            if(!indExpe){
           PdfPCell cellLeve2Lr= new PdfPCell(new Paragraph("Expenses",font2));
       cellLeve2Lr.setColspan(6);
      cellLeve2Lr.setFixedHeight(16.2f);
     ...
     PdfPCell balAmountL=null;
      double amountL=parseDouble(rdb.getBalances(level5aLdcs.get(z1Ldcs),startDate, endDate).get(level5aLdcs.get(z1Ldcs)).toString());
      if(amountL<0.0){
       balAmountL= new PdfPCell(new Paragraph("("+ffm.formatForStatementNumbers(amountL+"")+")",font1));
      } else{
      ...
      sum1Ldcs= sum1Ldcs+(parseDouble(rdb.getBalances(level5aLdcs.get(z1Ldcs),startDate, endDate).get(level5aLdcs.get(z1Ldcs)).toString()));   
     ...
     table.addCell(cellEmpty);
       ...
       Map<Integer, String> level5aLdc=rdb.getLevel5Items("Closing Stock"); 
        ...
        if(parseDouble(rdb.getBalances(level5aLdc.get(z1Ldc),startDate, endDate).get(level5aLdc.get(z1Ldc)).toString())!=0.0){
            if(!indExpe){
           PdfPCell cellLeve2Lr= new PdfPCell(new Paragraph("Expenses",font2));
       cellLeve2Lr.setColspan(6);
      cellLeve2Lr.setFixedHeight(16.2f);
     ...
     PdfPCell balAmountL=null;
      double amountL=parseDouble(rdb.getBalances(level5aLdc.get(z1Ldc),startDate, endDate).get(level5aLdc.get(z1Ldc)).toString());
      if(amountL<0.0){
       balAmountL= new PdfPCell(new Paragraph("("+ffm.formatForStatementNumbers(amountL+"")+")",font1));
      } else{
      ...
      table.addCell(cellEmpty);
       ...
       sum1Ldc= sum1Ldc+(parseDouble(rdb.getBalances(level5aLdc.get(z1Ldc),startDate, endDate).get(level5aLdc.get(z1Ldc)).toString()));   
   ...
   case "Operating Expenses":
       ...
       Map<Integer, String> level5Lk=rdb.getLevel5Items("Operating Expense"); 
        ...
        if(parseDouble(rdb.getBalances(level5Lk.get(zLk),startDate, endDate).get(level5Lk.get(zLk)).toString())!=0.0){
            if(!indExpe){
           PdfPCell cellLeve2Lr= new PdfPCell(new Paragraph("Expenses",font2));
       cellLeve2Lr.setColspan(6);
      cellLeve2Lr.setFixedHeight(16.2f);
     ...
     cellLeve4Lk.setColspan(5);
      ...
      PdfPCell balAmountL=null;
      double amountL=parseDouble(rdb.getBalances(level5Lk.get(zLk),startDate, endDate).get(level5Lk.get(zLk)).toString());
      if(amountL<0.0){
       balAmountL= new PdfPCell(new Paragraph("("+ffm.formatForStatementNumbers(amountL+"")+")",font1));
      } else{
     ...
     table.addCell(balAmountL);
      ...
      table.addCell(cellEmpty);
       ...
       sumLk= sumLk+(parseDouble(rdb.getBalances(level5Lk.get(zLk),startDate, endDate).get(level5Lk.get(zLk)).toString()));     
       operatingEXP=true; 
        }
     ...
     table.addCell(cellEmpty);
       ...
       Map<Integer, String> level5Lf=rdb.getLevel5Items("Financing Expense"); 
        ...
        if(parseDouble(rdb.getBalances(level5Lf.get(zLf),startDate, endDate).get(level5Lf.get(zLf)).toString())!=0.0){
           if(!indExpe){
           PdfPCell cellLeve2Lr= new PdfPCell(new Paragraph("Expenses",font2));
       cellLeve2Lr.setColspan(6);
      cellLeve2Lr.setFixedHeight(16.2f);
     ...
     cellLeve4Lf.setColspan(5);
      ...
      PdfPCell balAmountL=null;
      double amountL=parseDouble(rdb.getBalances(level5Lf.get(zLf),startDate, endDate).get(level5Lf.get(zLf)).toString());
      if(amountL<0.0){
       balAmountL= new PdfPCell(new Paragraph("("+ffm.formatForStatementNumbers(amountL+"")+")",font1));
      } else{
     ...
     table.addCell(balAmountL);
      ...
      table.addCell(cellEmpty);
       ...
       sumLf= sumLf+(parseDouble(rdb.getBalances(level5Lf.get(zLf),startDate, endDate).get(level5Lf.get(zLf)).toString()));     
       finExp=true; 
        }
     ...
     table.addCell(cellEmpty);
      ...
      case "Administrative Expenses":
       ...
       Map<Integer, String> level5L=rdb.getLevel5Items("Administrative Expense"); 
        ...
        if(parseDouble(rdb.getBalances(level5L.get(zL),startDate, endDate).get(level5L.get(zL)).toString())!=0.0){
             if(!indExpe){
           PdfPCell cellLeve2Lr= new PdfPCell(new Paragraph("Expenses",font2));
       cellLeve2Lr.setColspan(6);
      cellLeve2Lr.setFixedHeight(16.2f);
     ...
     cellLeve4L.setColspan(5);
      ...
      PdfPCell balAmountL=null;
      double amountL=parseDouble(rdb.getBalances(level5L.get(zL),startDate, endDate).get(level5L.get(zL)).toString());
      if(amountL<0.0){
       balAmountL= new PdfPCell(new Paragraph("("+ffm.formatForStatementNumbers(amountL+"")+")",font1));
      } else{
     ...
     table.addCell(balAmountL);
      ...
      table.addCell(cellEmpty);
       ...
       sumL= sumL+(parseDouble(rdb.getBalances(level5L.get(zL),startDate, endDate).get(level5L.get(zL)).toString()));     
       adminExp=true; 
        }
     ...
     table.addCell(cellEmpty);
      ...
      case   "Employment Expense" :
       ...
       Map<Integer, String> level5aLm=rdb.getLevel5Items("Employment Expense"); 
        ...
        if(parseDouble(rdb.getBalances(level5aLm.get(z1Lm),startDate, endDate).get(level5aLm.get(z1Lm)).toString())!=0.0){
             if(!indExpe){
           PdfPCell cellLeve2Lr= new PdfPCell(new Paragraph("Expenses",font2));
       cellLeve2Lr.setColspan(6);
      cellLeve2Lr.setFixedHeight(16.2f);
     ...
     PdfPCell balAmountL=null;
      double amountL=parseDouble(rdb.getBalances(level5aLm.get(z1Lm),startDate, endDate).get(level5aLm.get(z1Lm)).toString());
      if(amountL<0.0){
       balAmountL= new PdfPCell(new Paragraph("("+ffm.formatForStatementNumbers(amountL+"")+")",font1));
      } else{
      ...
      table.addCell(cellEmpty);
       ...
       employExp=true;
       sum1mL= sum1mL+(parseDouble(rdb.getBalances(level5aLm.get(z1Lm),startDate, endDate).get(level5aLm.get(z1Lm)).toString())); 
        }
     ...
     table.addCell(cellEmpty);
      ...
      table.addCell(cellEmpty);
       ...
       Map<Integer, String> level5Lfx=rdb.getLevel5Items("Expense Purely Related To Short Term Insurance Business Income"); 
        ...
        if(parseDouble(rdb.getBalances(level5Lfx.get(zLfx),startDate, endDate).get(level5Lfx.get(zLfx)).toString())!=0.0){
            if(!indExpe){
           PdfPCell cellLeve2Lr= new PdfPCell(new Paragraph("Expenses",font2));
       cellLeve2Lr.setColspan(6);
      cellLeve2Lr.setFixedHeight(16.2f);
     ...
     cellLeve4Lfx.setColspan(5);
      ...
      PdfPCell balAmountL=null;
      double amountL=parseDouble(rdb.getBalances(level5Lfx.get(zLfx),startDate, endDate).get(level5Lfx.get(zLfx)).toString());
      if(amountL<0.0){
       balAmountL= new PdfPCell(new Paragraph("("+ffm.formatForStatementNumbers(amountL+"")+")",font1));
      } else{
     ...
     table.addCell(balAmountL);
      ...
      table.addCell(cellEmpty);
       ...
       sumLfx= sumLfx+(parseDouble(rdb.getBalances(level5Lfx.get(zLfx),startDate, endDate).get(level5Lfx.get(zLfx)).toString()));     
       Insurance=true; 
        }
     ...
     table.addCell(cellEmpty);
       ...
       Map<Integer, String> level5hszg=rdb.getLevel5Items("General Expensee"); 
        ...
        if(parseDouble(rdb.getBalances(level5hszg.get(zhszg),startDate, endDate).get(level5hszg.get(zhszg)).toString())!=0.0){
             if(!indExpe){
           PdfPCell cellLeve2Lr= new PdfPCell(new Paragraph("Expenses",font2));
       cellLeve2Lr.setColspan(6);
      cellLeve2Lr.setFixedHeight(16.2f);
     ...
     cellLeve4Lfxg.setColspan(5);
      ...
      PdfPCell balAmountL=null;
      double amountL=parseDouble(rdb.getBalances(level5hszg.get(zhszg),startDate, endDate).get(level5hszg.get(zhszg)).toString());
      if(amountL<0.0){
       balAmountL= new PdfPCell(new Paragraph("("+ffm.formatForStatementNumbers(amountL+"")+")",font1));
      } else{
     ...
     table.addCell(balAmountL);
      ...
      table.addCell(cellEmpty);
       ...
       sumhsg= sumhsg+(parseDouble(rdb.getBalances(level5hszg.get(zhszg),startDate, endDate).get(level5hszg.get(zhszg)).toString()));     
       general=true; 
        }
     ...
     break;  
      ...
      table.addCell(cellEmpty);
       ...
       Map<Integer, String> level5h=rdb.getLevel5Items("Income Taxes Expense"); 
        ...
        if(parseDouble(rdb.getBalances(level5h.get(zh),startDate, endDate).get(level5h.get(zh)).toString())!=0.0){
         if(!indExpe14){
             if(level5h.size()>1){
        table.addCell(cellEmpty);
     ...
     cellLeve4Lfx.setColspan(5);
      ...
      PdfPCell balAmountL=null;
      double amountL=parseDouble(rdb.getBalances(level5h.get(zh),startDate, endDate).get(level5h.get(zh)).toString());
      if(amountL<0.0){
       balAmountL= new PdfPCell(new Paragraph("("+ffm.formatForStatementNumbers(amountL+"")+")",font1));
      } else{
     ...
     table.addCell(balAmountL);
      ...
      table.addCell(cellEmpty);
       ...
       sumh= sumh+(parseDouble(rdb.getBalances(level5h.get(zh),startDate, endDate).get(level5h.get(zh)).toString()));     
       incomeTax=true; 
        }
    ...
    table.addCell(cellEmpty);
     ...
     table.addCell(cellEmpty);
      ...
      table.addCell(cellEmpty);
       ...
       Map<Integer, String> level5hs=rdb.getLevel5Items("Dividend paid during the period"); 
        ...
        if(parseDouble(rdb.getBalances(level5hs.get(zhs),startDate, endDate).get(level5hs.get(zhs)).toString())!=0.0){
          if(!indExpe13){
              if(level5hs.size()>1){
        table.addCell(cellEmpty);
     table.addCell(cellEmpty);
     ...
     cellLeve4Lfx.setColspan(5);
      ...
      PdfPCell balAmountL=null;
      double amountL=parseDouble(rdb.getBalances(level5hs.get(zhs),startDate, endDate).get(level5hs.get(zhs)).toString());
      if(amountL<0.0){
       balAmountL= new PdfPCell(new Paragraph("("+ffm.formatForStatementNumbers(amountL+"")+")",font1));
      } else{
     ...
     table.addCell(balAmountL);
      ...
      table.addCell(cellEmpty);
       ...
       sumhs= sumhs+(parseDouble(rdb.getBalances(level5hs.get(zhs),startDate, endDate).get(level5hs.get(zhs)).toString()));     
       proposedDev=true; 
        }
    ...
    table.addCell(cellEmpty);
     ...
     table.addCell(cellEmpty);
      ...
      table.addCell(cellEmpty);
       ...
       Map<Integer, String> level5hsz=rdb.getLevel5Items("Retained earning at start of period"); 
        ...
        if(parseDouble(rdb.getBalances(level5hsz.get(zhsz),startDate, endDate).get(level5hsz.get(zhsz)).toString())!=0.0){
          if(!indExpe12){
              if(level5hsz.size()>1){
        table.addCell(cellEmpty);
     ...
     cellLeve4Lfx.setColspan(5);
      ...
      PdfPCell balAmountL=null;
      double amountL=parseDouble(rdb.getBalances(level5hsz.get(zhsz),startDate, endDate).get(level5hsz.get(zhsz)).toString());
      if(amountL<0.0){
       balAmountL= new PdfPCell(new Paragraph("("+ffm.formatForStatementNumbers(amountL+"")+")",font1));
      } else{
     ...
     table.addCell(balAmountL);
      ...
      table.addCell(cellEmpty);
       ...
       sumhs= sumhs+(parseDouble(rdb.getBalances(level5hsz.get(zhsz),startDate, endDate).get(level5hsz.get(zhsz)).toString()));     
       balOfProfit=true; 
        }
