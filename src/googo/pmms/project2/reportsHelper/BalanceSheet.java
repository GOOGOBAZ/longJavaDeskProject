...
this.userId=userid;
  ...
  public boolean createBalanceSheet(String SheetDate,String fileName) { 
...
createActuallyBalanceSheet( SheetDate,fileName);
BalanceSheet=true;
  } 
...
BalanceSheet=true;
      ...
      private void createActuallyBalanceSheet(String SheetDate,String fileName){
      try {
          ...
          PdfWriter writer=PdfWriter.getInstance(document, fios.FileOutputStream(fios.createFileName("PMMS_Statements", "PMMS_Statements1", fileName+".pdf")));
            body = createTodayBalanceSheet(SheetDate);
      ...
      public  PdfPTable createTodayBalanceSheet(String sheetDate){
  ...
  while(z<=level5.size()-1){
        ...
        if(parseDouble(rdb.getBalancesSheet(level5.get(z),sheetDate).get(level5.get(z)).toString())!=0.0){
            if(!fixedAExists){
      table.addCell(cellEmpty);
     ...
     cellLeve4.setColspan(5);
      ...
      double amount=parseDouble(rdb.getBalancesSheet(level5.get(z),sheetDate).get(level5.get(z)).toString());
      if(amount<0.0){
     ...
     table.addCell(balAmount);
      ...
      table.addCell(cellEmpty);
       ...
       sum= sum+(parseDouble(rdb.getBalancesSheet(level5.get(z),sheetDate).get(level5.get(z)).toString()));    
       fixedIndicator=true;
        }
          if(level5.get(z).equalsIgnoreCase("Accumulated Depreciation/Amortization")){
        ...
        TotalHolder.put(0, parseDouble(rdb.getBalancesSheet(level5.get(z),sheetDate).get(level5.get(z)).toString()));
     ...
     table.addCell(cellEmpty);
      ...
      case   "Investments" :
       ...
       while(z1<=level5a.size()-1){
        ...
        if(parseDouble(rdb.getBalancesSheet(level5a.get(z1),sheetDate).get(level5a.get(z1)).toString())!=0.0){
     ...
     PdfPCell balAmount=null;
      double amount=parseDouble(rdb.getBalancesSheet(level5a.get(z1),sheetDate).get(level5a.get(z1)).toString());
      if(amount<0.0){
       balAmount= new PdfPCell(new Paragraph("("+ffm.formatForStatementNumbers(amount+"")+")",font1));
      } else{
      ...
      table.addCell(cellEmpty);
       ...
       sum1= sum1+(parseDouble(rdb.getBalancesSheet(level5a.get(z1),sheetDate).get(level5a.get(z1)).toString()));   
        z1++; 
  ...
  while(zb<=level5b.size()-1){
        ...
        if(parseDouble(rdb.getBalancesSheet(level5b.get(zb),sheetDate).get(level5b.get(zb)).toString())!=0.0){
     ...
     cellLeve4.setColspan(5);
      ...
      double amountb=parseDouble(rdb.getBalancesSheet(level5b.get(zb),sheetDate).get(level5b.get(zb)).toString());
      if(amountb<0.0){
     ...
     table.addCell(balAmountb);
      ...
      table.addCell(cellEmpty);
       ...
       sumb= sumb+(parseDouble(rdb.getBalancesSheet(level5b.get(zb),sheetDate).get(level5b.get(zb)).toString()));   
    ...
    totalAmount= new PdfPCell(new Paragraph(ffm.formatForStatementNumbers(sumTotal+""),font1));
     ...
     table.addCell(cellEmpty);
      ...
      case   "Accounts Receivables/Debtors":
       ...
       Map<Integer, String> level5ab=rdb.getLevel5Items("Accounts Receivables/Debtors"); 
        ...
        if(parseDouble(rdb.getBalancesSheet(level5ab.get(z1b),sheetDate).get(level5ab.get(z1b)).toString())!=0.0){
            if(!accountsRExists){
      table.addCell(cellEmpty);
     ...
     PdfPCell balAmountb=null;
      double amountb=parseDouble(rdb.getBalancesSheet(level5ab.get(z1b),sheetDate).get(level5ab.get(z1b)).toString());
      if(amountb<0.0){
       balAmountb= new PdfPCell(new Paragraph("("+ffm.formatForStatementNumbers(amountb+"")+")",font1));
      } else{
      ...
      indicatorReceivable=true;
       ...
       sum1b= sum1b+(parseDouble(rdb.getBalancesSheet(level5ab.get(z1b),sheetDate).get(level5ab.get(z1b)).toString()));   
        z1b++; }
     ...
     table.addCell(cellEmpty);                
       ...
       while(z1bc<=level5abc.size()-1){
        ...
        if(parseDouble(rdb.getBalancesSheet(level5abc.get(z1bc),sheetDate).get(level5abc.get(z1bc)).toString())!=0.0){
            if(!cashBankBal){
      table.addCell(cellEmpty);
     ...
     PdfPCell balAmountbc=null;
      double amountbc=parseDouble(rdb.getBalancesSheet(level5abc.get(z1bc),sheetDate).get(level5abc.get(z1bc)).toString());
      if(amountbc<0.0){
    ...
    indicatorCash=true;
       ...
       sum1bc= sum1bc+(parseDouble(rdb.getBalancesSheet(level5abc.get(z1bc),sheetDate).get(level5abc.get(z1bc)).toString()));   
        z1bc++; }
              if(indicatorCash){
     ...
     table.addCell(cellEmpty);              
       ...
       while(z1bA1<=level5abA1.size()-1){
        ...
        if(parseDouble(rdb.getBalancesSheet(level5abA1.get(z1bA1),sheetDate).get(level5abA1.get(z1bA1)).toString())!=0.0){
            if(!loanThere){
      table.addCell(cellEmpty);
     ...
     PdfPCell balAmountb1=null;
      double amountbA1=parseDouble(rdb.getBalancesSheet(level5abA1.get(z1bA1),sheetDate).get(level5abA1.get(z1bA1)).toString());
      if(amountbA1<0.0){
      ...
      table.addCell(cellEmpty);
       ...
       sum1bA1= sum1bA1+(parseDouble(rdb.getBalancesSheet(level5abA1.get(z1bA1),sheetDate).get(level5abA1.get(z1bA1)).toString()));   
        z1bA1++; }
               if(indicatorLoan){ 
  ...
  boolean defferedTaxa=false;
       ...
       Map<Integer, String> level5=rdb.getLevel5Items("Deferred Tax Assets"); 
        ...
        if(parseDouble(rdb.getBalancesSheet(level5.get(zX),sheetDate).get(level5.get(zX)).toString())!=0.0){
     ...
     cellLeve4X.setColspan(5);
      ...
      double amountX=parseDouble(rdb.getBalancesSheet(level5.get(zX),sheetDate).get(level5.get(zX)).toString());
     ...
     table.addCell(balAmountX);
      ...
      table.addCell(cellEmpty);
       ...
       sumX= sumX+(parseDouble(rdb.getBalancesSheet(level5.get(zX),sheetDate).get(level5.get(zX)).toString()));  
       defferedTaxa=true;
        }
   ...
   while(zL<=level5L.size()-1){
        ...
        if(parseDouble(rdb.getBalancesSheet(level5L.get(zL),sheetDate).get(level5L.get(zL)).toString())!=0.0){
            if(!currentThere){
      table.addCell(cellEmpty);
     ...
     cellLeve4L.setColspan(5);
      ...
      double amountL=parseDouble(rdb.getBalancesSheet(level5L.get(zL),sheetDate).get(level5L.get(zL)).toString());
      if(amountL<0.0){
     ...
     table.addCell(balAmountL);
      ...
      table.addCell(cellEmpty);
       ...
       sumL= sumL+(parseDouble(rdb.getBalancesSheet(level5L.get(zL),sheetDate).get(level5L.get(zL)).toString()));     
     ...
     {totalAmount= new PdfPCell(new Paragraph("("+ffm.formatForStatementNumbers(TotalHolder.get(12)+"")+")",font1));
      ...
      case   "Provisions" :
       ...
       Map<Integer, String> level5aL=rdb.getLevel5Items("Provisions"); 
        ...
        if(parseDouble(rdb.getBalancesSheet(level5aL.get(z1L),sheetDate).get(level5aL.get(z1L)).toString())!=0.0){
            if(!provisionsThere){
      table.addCell(cellEmpty);
     ...
     PdfPCell balAmountL=null;
      double amountL=parseDouble(rdb.getBalancesSheet(level5aL.get(z1L),sheetDate).get(level5aL.get(z1L)).toString());
      if(amountL<0.0){
       balAmountL= new PdfPCell(new Paragraph("("+ffm.formatForStatementNumbers(amountL+"")+")",font1));
      } else{
      ...
      table.addCell(cellEmpty);
       ...
       sum1L= sum1L+(parseDouble(rdb.getBalancesSheet(level5aL.get(z1L),sheetDate).get(level5aL.get(z1L)).toString()));   
        z1L++; }
              if(provision){
     ...
     table.addCell(cellEmpty);
       ...
       Map<Integer, String> level5bL=rdb.getLevel5Items("Secured Liabilities");
        ...
        if(parseDouble(rdb.getBalancesSheet(level5bL.get(zbL),sheetDate).get(level5bL.get(zbL)).toString())!=0.0){
      if(!suredThere){
      table.addCell(cellEmpty);
     ...
     cellLeve4LA.setColspan(5);
      ...
      double amountbL=parseDouble(rdb.getBalancesSheet(level5bL.get(zbL),sheetDate).get(level5bL.get(zbL)).toString());
      if(amountbL<0.0){
     ...
     table.addCell(balAmountbL);
      ...
      table.addCell(cellEmpty);
      noncursecLiab=true;
       sumbL= sumbL+(parseDouble(rdb.getBalancesSheet(level5bL.get(zbL),sheetDate).get(level5bL.get(zbL)).toString()));     
        }
    ...
    totalAmountA= new PdfPCell(new Paragraph(ffm.formatForStatementNumbers(sumTotalA+""),font1));
     ...
     break;
      ...
      case   "Unsecured Liabilities":
       ...
       while(z1bL<=level5abL.size()-1){
        ...
        if(parseDouble(rdb.getBalancesSheet(level5abL.get(z1bL),sheetDate).get(level5abL.get(z1bL)).toString())!=0.0){
            if(!unsecuredLthere){
      table.addCell(cellEmpty);
     ...
     PdfPCell balAmountbL=null;
      double amountbL=parseDouble(rdb.getBalancesSheet(level5abL.get(z1bL),sheetDate).get(level5abL.get(z1bL)).toString());
      if(amountbL<0.0){
       balAmountbL= new PdfPCell(new Paragraph("("+ffm.formatForStatementNumbers(amountbL+"")+")",font1));
      } else{
      ...
      table.addCell(cellEmpty);
       ...
       sum1bL= sum1bL+(parseDouble(rdb.getBalancesSheet(level5abL.get(z1bL),sheetDate).get(level5abL.get(z1bL)).toString()));   
        z1bL++; }
              if(noncurunseclian){
  ...
  int yXL=0;
     ...
     cellLeve4XL.setColspan(5);
      ...
      cellLeve4XL.setVerticalAlignment(Element.ALIGN_TOP);
       ...
       table.addCell(cellLeve4XL);
        ...
        if(parseDouble(rdb.getBalancesSheet(level5L.get(zXL),sheetDate).get(level5L.get(zXL)).toString())!=0.0){
      ...
      double amountXL=parseDouble(rdb.getBalancesSheet(level5L.get(zXL),sheetDate).get(level5L.get(zXL)).toString());
      if(amountXL<0.0){
    ...
    table.addCell(cellEmpty);
       ...
       sumXL= sumXL+(parseDouble(rdb.getBalancesSheet(level5L.get(zXL),sheetDate).get(level5L.get(zXL)).toString()));     
      taxLiabi=true;
        }
  ...
  while(zLe<=level5Le.size()-1){
        ...
        if(parseDouble(rdb.getBalancesSheet(level5Le.get(zLe),sheetDate).get(level5Le.get(zLe)).toString())!=0.0){
            if(!sharesThere){
      table.addCell(cellEmpty);
     ...
     cellLeve4Le.setColspan(5);
      ...
      double amountLe=parseDouble(rdb.getBalancesSheet(level5Le.get(zLe),sheetDate).get(level5Le.get(zLe)).toString());
      if(amountLe<0.0){
     ...
     table.addCell(balAmountLe);
      ...
      table.addCell(cellEmpty);
       ...
       sumLe= sumLe+(parseDouble(rdb.getBalancesSheet(level5Le.get(zLe),sheetDate).get(level5Le.get(zLe)).toString()));     
     ...
     {totalAmount= new PdfPCell(new Paragraph("("+ffm.formatForStatementNumbers(TotalHolder.get(22)+"")+")",font1));
      ...
      case   "Reserves And Surplus" :
       ...
       Map<Integer, String> level5aL=rdb.getLevel5Items("Reserves And Surplus"); 
        ...
        if(parseDouble(rdb.getBalancesSheet(level5aL.get(z1Le),sheetDate).get(level5aL.get(z1Le)).toString())!=0.0){
     ...
     amountLe=parseDouble(rdb.getBalancesSheet(level5aL.get(z1Le),sheetDate).get(level5aL.get(z1Le)).toString())+parseDouble(netprofits.theNetProfits(ffm.forDatabaseWithFullYearBeginningWithDate(fios.stringFileReader(fios.createFileName("persistence", "operatingCycle", "YEARstartDate.txt"))),sheetDate));
//         sum1Le=amountLe; 
     isretain=true;
          table.addCell(cellEmpty);
      ...
      table.addCell(cellEmpty);
    amountLe=parseDouble(rdb.getBalancesSheet(level5aL.get(z1Le),sheetDate).get(level5aL.get(z1Le)).toString());
...
//     PdfPCell balAmountLe=null; double amountLe=0.0;
  ...
  amountLe=parseDouble(netprofits.theNetProfits(ffm.forDatabaseWithFullYearBeginningWithDate(fios.stringFileReader(fios.createFileName("persistence", "operatingCycle", "YEARstartDate.txt"))),sheetDate));
...
//        sum1Le=amountLe;
        ...
        finalT=(parseDouble(rdb.getBalancesSheet(level5aL.get(z1Le),sheetDate).get(level5aL.get(z1Le)).toString()));
        }
...
private Paragraph createHeading(String sheetDate) {
  ...
  return ss;
    ...
    public void onGenericTag(PdfWriter writer, Document document, Rectangle rect, String text) {
        ...
        public List<List>balanceSheetAggregator(String startDate,String sheetDate){
