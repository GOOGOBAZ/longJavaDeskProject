...
retaiStartExpensesAccounts.add("Retained earning at start of period");
  ...
  public List<List<Object>> expensesDeclared(){
...
for(Map.Entry<Integer, String> entry:level5.entrySet()){
        ...
        if(parseDouble(rdb.getBalances(entry.getValue(),exoebseDateStart,exoebseDateEnd).get(entry.getValue()).toString())!=0.0){
        ...
        expensesDe.add(parseDouble(rdb.getBalances(entry.getValue(),exoebseDateStart,exoebseDateEnd).get(entry.getValue()).toString()));
        


        if(parseDouble(rdb.getBalances(entry.getValue(),ffm.earlierDate(exoebseDateStart),ffm.earlierDate(exoebseDateEnd)).get(entry.getValue()).toString())==0){
        
            expensesDe.add("-");
            
        }else{
        
        expensesDe.add(parseDouble(rdb.getBalances(entry.getValue(),ffm.earlierDate(exoebseDateStart),ffm.earlierDate(exoebseDateEnd)).get(entry.getValue()).toString()));
...
mainexpenset.add(expensesDe);
    ...
    public List<List<Object>>  incomeTaxE(){
...
for(Map.Entry<Integer, String> entry:level5.entrySet()){
        ...
        incomeTaxK.add(parseDouble(rdb.getBalances(entry.getValue(),exoebseDateStart,exoebseDateEnd).get(entry.getValue()).toString()));
        ...
        incomeTaxK.add(parseDouble(rdb.getBalances(entry.getValue(),ffm.earlierDate(exoebseDateStart),ffm.earlierDate(exoebseDateEnd)).get(entry.getValue()).toString()));
...
incomeTaxList.add(incomeTaxK);
   ...
   public List<List<Object>> devidendsPaidInAyear(){
...
for(Map.Entry<Integer, String> entry:level5.entrySet()){
        ...
        devidendsPaidY.add(parseDouble(rdb.getBalances(entry.getValue(),exoebseDateStart,exoebseDateEnd).get(entry.getValue()).toString()));
        ...
        devidendsPaidY.add(parseDouble(rdb.getBalances(entry.getValue(),ffm.earlierDate(exoebseDateStart),ffm.earlierDate(exoebseDateEnd)).get(entry.getValue()).toString()));
...
devdendPaidList.add(devidendsPaidY);
    ...
    public List<List<Object>> periodErrorS(){
...
for(Map.Entry<Integer, String> entry:level5.entrySet()){
        ...
        periodErrord.add(parseDouble(rdb.getBalances(entry.getValue(),exoebseDateStart,exoebseDateEnd).get(entry.getValue()).toString()));
        ...
        periodErrord.add(parseDouble(rdb.getBalances(entry.getValue(),ffm.earlierDate(exoebseDateStart),ffm.earlierDate(exoebseDateEnd)).get(entry.getValue()).toString()));
...
mainPeriodErrorsList.add(periodErrord);
     ...
     public List<List<Object>> periodAccountPolicy(){
...
for(Map.Entry<Integer, String> entry:level5.entrySet()){
        ...
        changeAccountP.add(parseDouble(rdb.getBalances(entry.getValue(),exoebseDateStart,exoebseDateEnd).get(entry.getValue()).toString()));
        ...
        changeAccountP.add(parseDouble(rdb.getBalances(entry.getValue(),ffm.earlierDate(exoebseDateStart),ffm.earlierDate(exoebseDateEnd)).get(entry.getValue()).toString()));
...
changeAccountList.add(changeAccountP);
     ...
     return changeAccountList;
      ...
      public List<List<Object>> retainedEarningY(){
...
for(Map.Entry<Integer, String> entry:level5.entrySet()){
        ...
        retainedEarning.add(parseDouble(rdb.getBalances(entry.getValue(),exoebseDateStart,exoebseDateEnd).get(entry.getValue()).toString()));
        ...
        retainedEarning.add(parseDouble(rdb.getBalances(entry.getValue(),ffm.earlierDate(exoebseDateStart),ffm.earlierDate(exoebseDateEnd)).get(entry.getValue()).toString()));
