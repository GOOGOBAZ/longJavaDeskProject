...
nonCurrentAssetsY.add("Fixed Assets/Non-Current Assets");
  ...
  public List<List<Object>> currentAssets(){
...
for(Map.Entry<Integer, String> entry:level5.entrySet()){
        ...
        currentAssetsvx.add(parseDouble(rdb.getBalancesSheet(entry.getValue(),balanceSheetDate).get(entry.getValue()).toString()));
        ...
        currentAssetsvx.add(parseDouble(rdb.getBalancesSheet(entry.getValue(),ffm.earlierDate(balanceSheetDate)).get(entry.getValue()).toString()));
...
currentAssetsvT.add(currentAssetsvx);
    ...
    public List<List<Object>>  nonCurrentAssets(){
