...
public class SelectedAccountDetails extends javax.swing.JFrame implements MouseListener, IUpdateText, ActionListener{
 ...
 switch(dfestinationView){
     ...
     case "LStatmentView":
         dbq.fillMeWithLoanStatementIn(jTable1);
...
TableRowSorter<TableModel> rowSorter  = new TableRowSorter<>(table.getModel());
    ...
    SelectedAccountDetailsDetails theNames=new SelectedAccountDetailsDetails(this.userId,"LStatmentViewDetails",accountNumber);

      fios.stringFileWriter(fios.createFileName("loanApplication", "amortValues", "stateName"+this.userId+".txt"), jTable1.getModel().getValueAt( jTable1.convertRowIndexToModel(selectedRow), 1).toString());
