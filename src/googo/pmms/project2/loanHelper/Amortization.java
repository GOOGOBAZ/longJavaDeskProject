...
return cash;
    ...
    public double calculateInstalmentReducingInnterestAmount(double initialAmount, double interest, int totalNumberOfPayments, int periodOfTime){
 double instalment=0.0;
 ...
 return instalment;
    ...
    public double interestInstalmentReducingInterest(double initialAmountTI, double interest1TI,int tenure1TI, int PaymentPlan1TI){
    
    interestInstalmentvx  =calculateInstalmentReducingInnterestAmount(initialAmountTI, interest1TI, tenure1TI, PaymentPlan1TI)-(periodInterestRate(interest1TI, PaymentPlan1TI)*initialAmountTI);
    return (periodInterestRate(interest1TI, PaymentPlan1TI)*interestInstalmentvx) ;
    }
    
    
 public double totalInterestPaidReducingInterest(double initialAmountTI, double interest1TI,int tenure1TI, int PaymentPlan1TI){
     ...
     int i=0;
     instalmentAmount=calculateInstalmentReducingInnterestAmount(parseDouble(df1.format(initialAmountTI)), parseDouble(df1.format(interest1TI)),tenure1TI, PaymentPlan1TI);
     while (i<=tenure1TI-1){
...
int count=1, x=0;
 ...
 double principalInstalmentS= amount(initialPrincipleAmount, initialLoanTerm);
  ...
  double instalmentAmount= calculateInstalmentReducingInnterestAmount(initialPrincipleAmount, initialInterestRate, initialLoanTerm, parseInt(details.get(4).toString().replace("'", "").replace(".0", "")));
  ...
  double runningInterestBal=totalInterestPaidReducingInterest(initialPrincipleAmount, initialInterestRate,initialLoanTerm,parseInt(details.get(4).toString().replace("'", "").replace(".0", ""))); 
...
public ObjectTableModel amortizeReducingBalanceFixedInstalment( List details){
