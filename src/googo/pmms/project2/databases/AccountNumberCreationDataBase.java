...
this.userId=userid;
    ...
    public String createAccountNumber(String selection3,String ledgerProductCode,String ledgerProductName){
        String accountNumber="";
   
    switch(selection3){
    
        case "Land & Building":
           accountNumber= "01"+recentAccountMaster("1000000","1009999","01",ledgerProductCode,"Land & Building",ledgerProductName)+ledgerProductCode; 
            
            break;
            
case "Equipment & Machinery":
  
   accountNumber= "01"+recentAccountMaster("1010000","1019999","01",ledgerProductCode,"Equipment & Machinery",ledgerProductName)+ledgerProductCode;  
    break;		
case "Motor Vehicles":
    
    accountNumber= "01"+recentAccountMaster("1020000","1029999","01",ledgerProductCode,"Motor Vehicles",ledgerProductName)+ledgerProductCode;   
    break;		
case "Furniture, Fixtures & Fittings":
    
    accountNumber= "01"+recentAccountMaster("1030000","1039999","01",ledgerProductCode,"Furniture, Fixtures & Fittings",ledgerProductName)+ledgerProductCode; 
    
    break;		
case "Computer And Electronics":
   accountNumber= "01"+recentAccountMaster("1040000","1049999","01",ledgerProductCode,"Computer And Electronics",ledgerProductName)+ledgerProductCode;  
    
    
    break;		
case "Other Fixed Assets":
   accountNumber= "01"+recentAccountMaster("1050000","1059999","01",ledgerProductCode,"Other Fixed Assets",ledgerProductName)+ledgerProductCode;   
    
    break;		
case "Intangible Assets":
    
     accountNumber= "01"+recentAccountMaster("1060000","1069999","01",ledgerProductCode,"Intangible Assets",ledgerProductName)+ledgerProductCode; 
    
    break;		
case "Accumulated Depreciation/Amortization":
    
     accountNumber= "01"+recentAccountMaster("1070000","1079999","01",ledgerProductCode,"Accumulated Depreciation/Amortization",ledgerProductName)+ledgerProductCode; 
    break;		
case "Shares":
    
    accountNumber= "01"+recentAccountMaster("1080000","1089999","01",ledgerProductCode,"Shares",ledgerProductName)+ledgerProductCode;   
    
    break;		
case "Debentures":
   accountNumber= "01"+recentAccountMaster("1090000","1099999","01",ledgerProductCode,"Debentures",ledgerProductName)+ledgerProductCode;   
    
    break;		
case "Fixed Deposits":
    
     accountNumber= "01"+recentAccountMaster("1100000","1109999","01",ledgerProductCode,"Fixed Deposits",ledgerProductName)+ledgerProductCode; 
    break;		
case "Government Securities":
    
     accountNumber= "01"+recentAccountMaster("1110000","1119999","01",ledgerProductCode,"Government Securities",ledgerProductName)+ledgerProductCode; 
    
    break;		
case "Other Investments":
     accountNumber= "01"+recentAccountMaster("1120000","1129999","01",ledgerProductCode,"Other Investments",ledgerProductName)+ledgerProductCode;  
    break;		
case "Stores/Consumables Including Packing Materials":
     accountNumber= "01"+recentAccountMaster("1130000","1139999","01",ledgerProductCode,"Stores/Consumables Including Packing Materials",ledgerProductName)+ledgerProductCode;      
    break;		
case "Raw Materials":
      accountNumber= "01"+recentAccountMaster("1140000","1149999","01",ledgerProductCode,"Raw Materials",ledgerProductName)+ledgerProductCode; 
    
    break;		
case "Work-In-Progress":
     accountNumber= "01"+recentAccountMaster("1150000","1159999","01",ledgerProductCode,"Work-In-Progress",ledgerProductName)+ledgerProductCode;   
    break;		
case "Finished Goods Or Trade Goods":
    
     accountNumber= "01"+recentAccountMaster("1160000","1169999","01",ledgerProductCode,"Finished Good Or Trade Goods",ledgerProductName)+ledgerProductCode;  
    break;		
case "Trade Receivables":
    accountNumber= "01"+recentAccountMaster("1170000","1179999","01",ledgerProductCode,"Trade Receivables",ledgerProductName)+ledgerProductCode;  
    
    break;	
 case "Debtors":
      accountNumber= "01"+recentAccountMaster("1180000","1189999","01",ledgerProductCode,"Debtors",ledgerProductName)+ledgerProductCode;    
     
     break;

      case "Computer Software And Hardware":
      accountNumber= "01"+recentAccountMaster("1360000","1369999","01",ledgerProductCode,"Computer Software And Hardware",ledgerProductName)+ledgerProductCode;    
     
     break;
     
     
case "Interest Receivable":
  accountNumber= "01"+recentAccountMaster("1190000","1199999","01",ledgerProductCode,"Interest Receivable",ledgerProductName)+ledgerProductCode;   
    break;
    case "Accounts Receivable":
  accountNumber= "01"+recentAccountMaster("1310000","1319999","01",ledgerProductCode,"Accounts Receivable",ledgerProductName)+ledgerProductCode;   
    break;
    case "Allowance for Doubtful Accounts":
  accountNumber= "01"+recentAccountMaster("1320000","1329999","01",ledgerProductCode,"Allowance for Doubtful Accounts",ledgerProductName)+ledgerProductCode;   
    break;
    case "Allowance for Doubtful Interest":
  accountNumber= "01"+recentAccountMaster("1330000","1339999","01",ledgerProductCode,"Allowance for Doubtful Interest",ledgerProductName)+ledgerProductCode;   
    break;
    
    case "Accumulated Interest Receivable":
  accountNumber= "01"+recentAccountMaster("1340000","1349999","01",ledgerProductCode,"Accumulated Interest Receivable",ledgerProductName)+ledgerProductCode;   
    break;
     case "Loan Penalty Receivable":
  accountNumber= "01"+recentAccountMaster("1350000","1359999","01",ledgerProductCode,"Loan Penalty Receivable",ledgerProductName)+ledgerProductCode;   
    break;
case "Prepayments":
    
   accountNumber= "01"+recentAccountMaster("1200000","1209999","01",ledgerProductCode,"Prepayments",ledgerProductName)+ledgerProductCode;    
    
    break;		
case "Mobile Money":
   accountNumber= "01"+recentAccountMaster("1210000","1219999","01",ledgerProductCode,"Mobile Money",ledgerProductName)+ledgerProductCode;     
    
    break;
    
case "Bank Balance":
   accountNumber= "01"+recentAccountMaster("1220000","1229999","01",ledgerProductCode,"Bank Balance",ledgerProductName)+ledgerProductCode;    
    
    break;		
case "Cash At Hand":
  accountNumber= "01"+recentAccountMaster("1230000","1239999","01",ledgerProductCode,"Cash At Hand",ledgerProductName)+ledgerProductCode;     
    
    break;		
case "Cash Equivalents":
   accountNumber= "01"+recentAccountMaster("1240000","1249999","01",ledgerProductCode,"Cash Equivalents",ledgerProductName)+ledgerProductCode;      
    break;		
 case "Loans To Related Parties":
  accountNumber= "01"+recentAccountMaster("1250000","1259999","01",ledgerProductCode,"Loans To Related Parties",ledgerProductName)+ledgerProductCode;     
     
     break;		
case "Advances To Staff":
    accountNumber= "01"+recentAccountMaster("1260000","1269999","01",ledgerProductCode,"Advances To Staff",ledgerProductName)+ledgerProductCode;  
    break;	
case "Deposits (Other Than Fixed Deposit)":
   accountNumber= "01"+recentAccountMaster("1270000","1279999","01",ledgerProductCode,"Deposits (Other Than Fixed Deposit)",ledgerProductName)+ledgerProductCode;    
    break;		
case "Loans To Customers":
    accountNumber= "01"+recentAccountMaster("1280000","1289999","01",ledgerProductCode,"Loans To Customers",ledgerProductName)+ledgerProductCode; 
    
    break;		
case "Balances With Tax Authority":
   accountNumber= "01"+recentAccountMaster("1290000","1299999","01",ledgerProductCode,"Balances With Tax Authority",ledgerProductName)+ledgerProductCode;    
    
    break;		
case "Deferred Tax Asset":
   accountNumber= "01"+recentAccountMaster("1300000","1309999","01",ledgerProductCode,"Deferred Tax Asset",ledgerProductName)+ledgerProductCode; 
    break;
    
case "Accounts Payable":
  accountNumber= "05"+recentAccountMaster("5000000","5009999","05",ledgerProductCode,"Accounts Payable",ledgerProductName)+ledgerProductCode;   
    break;		
case "Creditors":
 accountNumber= "05"+recentAccountMaster("5010000","5019999","05",ledgerProductCode,"Creditors",ledgerProductName)+ledgerProductCode;  
    break;	
    
   
    
case "Customer Deposits":
  accountNumber= "05"+recentAccountMaster("5020000","5029999","05",ledgerProductCode,"Customer Deposits",ledgerProductName)+ledgerProductCode;     
    break;
    
    
case "Liability For Leased Assets":
    
   accountNumber= "05"+recentAccountMaster("5030000","5039999","05",ledgerProductCode,"Liability For Leased Assets",ledgerProductName)+ledgerProductCode;    
    break;	
   
case "Accrued Interest":
   accountNumber= "05"+recentAccountMaster("5040000","5049999","05",ledgerProductCode,"Accrued Interest",ledgerProductName)+ledgerProductCode;    
    
    break;		
case "Amounts Due To Others":
  accountNumber= "05"+recentAccountMaster("5050000","5059999","05",ledgerProductCode,"Amounts Due To Others",ledgerProductName)+ledgerProductCode;   
    break;		
case "Unpaid Matured Debts":
    
    accountNumber= "05"+recentAccountMaster("5060000","5069999","05",ledgerProductCode,"Unpaid Matured Debts",ledgerProductName)+ledgerProductCode;    
    
    break;		
case "Other Current Liabilities":
     accountNumber= "05"+recentAccountMaster("5070000","5079999","05",ledgerProductCode,"Other Current Liabilities",ledgerProductName)+ledgerProductCode;     
    
    break;	
  case "Return On Investment Payable":
     accountNumber= "05"+recentAccountMaster("5220000","5229999","05",ledgerProductCode,"Return On Investment Payable",ledgerProductName)+ledgerProductCode;     
    
    break; 
    
    case "Insurance Payable":
     accountNumber= "05"+recentAccountMaster("5240000","5249999","05",ledgerProductCode,"Insurance Payable",ledgerProductName)+ledgerProductCode;     
    
    break; 
     case "Interest Payable":
     accountNumber= "05"+recentAccountMaster("5250000","5259999","05",ledgerProductCode,"Interest Payable",ledgerProductName)+ledgerProductCode;     
    
    break;
    
     case "Tax Payable":
     accountNumber= "05"+recentAccountMaster("5260000","5269999","05",ledgerProductCode,"Tax Payable",ledgerProductName)+ledgerProductCode;     
    
    break;
    
    case "PAYE Payable":
     accountNumber= "05"+recentAccountMaster("5270000","5279999","05",ledgerProductCode,"PAYE Payable",ledgerProductName)+ledgerProductCode;     
    
    break;
    case  "NSSF Payable":
     accountNumber= "05"+recentAccountMaster("5280000","5289999","05",ledgerProductCode, "NSSF Payable",ledgerProductName)+ledgerProductCode;     
     
    break;
   
     case "Unclassified Amounts":
     accountNumber= "05"+recentAccountMaster("5230000","5239999","05",ledgerProductCode,"Unclassified Amounts",ledgerProductName)+ledgerProductCode;     
    
    break;  
    
case "Provision For Income Tax":
    
       accountNumber= "05"+recentAccountMaster("5080000","5089999","05",ledgerProductCode,"Provision For Income Tax",ledgerProductName)+ledgerProductCode;     
    break;		
case "Provision For Bad Debts":
    
    accountNumber= "05"+recentAccountMaster("5090000","5099999","05",ledgerProductCode,"Provision For Bad Debts",ledgerProductName)+ledgerProductCode; 
    break;		
case "Proposed Dividends":
   accountNumber= "05"+recentAccountMaster("5100000","5109999","05",ledgerProductCode,"Proposed Dividends",ledgerProductName)+ledgerProductCode;   
    
    break;		
case "Other Provisions":
    accountNumber= "05"+recentAccountMaster("5110000","5119999","05",ledgerProductCode,"Other Provisions",ledgerProductName)+ledgerProductCode;      
    break;		
case "Secured Loan From Financial Institutions":
    
     accountNumber= "05"+recentAccountMaster("5120000","5129999","05",ledgerProductCode,"Secured Loan From Financial Institutions",ledgerProductName)+ledgerProductCode;    
    break;		
case "Secured Other Loans":
      accountNumber= "05"+recentAccountMaster("5130000","5139999","05",ledgerProductCode,"Secured Other Loans",ledgerProductName)+ledgerProductCode; 
    
    break;		
case "Debt Securities Issued":
    accountNumber= "05"+recentAccountMaster("5140000","5149999","05",ledgerProductCode,"Debt Securities Issued",ledgerProductName)+ledgerProductCode;    
    
    break;		
case "Secured Due To Related Parties":
    
     accountNumber= "05"+recentAccountMaster("5150000","5159999","05",ledgerProductCode,"Secured Due To Related Parties",ledgerProductName)+ledgerProductCode;  
    break;		
case "Unsecured Loan From Financial Institutions":
     accountNumber= "05"+recentAccountMaster("5160000","5169999","05",ledgerProductCode,"Unsecured Loan From Financial Institutions",ledgerProductName)+ledgerProductCode;   
    break;		
case "Unsecured Other Loans":
    
       accountNumber= "05"+recentAccountMaster("5170000","5179999","05",ledgerProductCode,"Unsecured Other Loans",ledgerProductName)+ledgerProductCode;   
    break;		
case "Payables For More Than One Operating Cycle":
    
    accountNumber= "05"+recentAccountMaster("5180000","5189999","05",ledgerProductCode,"Payables For More Than One Operating Cycle",ledgerProductName)+ledgerProductCode;  
    
    break;		
case "Creditors For More Than One Operating Cycle":
    
      accountNumber= "05"+recentAccountMaster("5190000","5199999","05",ledgerProductCode,"Creditors For More Than One Operating Cycle",ledgerProductName)+ledgerProductCode;  
    break;		
case "Unsecured Due To Related Parties":
    
   accountNumber= "05"+recentAccountMaster("5200000","5209999","05",ledgerProductCode,"Unsecured Due To Related Parties",ledgerProductName)+ledgerProductCode;  
    
    break;		
case "Deferred Tax Liability":
     accountNumber= "05"+recentAccountMaster("5210000" ,"55219999","05",ledgerProductCode,"Deferred Tax Liability",ledgerProductName)+ledgerProductCode;  
    
    break;	
case "Sales":
   accountNumber= "03"+recentAccountMaster("3000000" ,"3009999","03",ledgerProductCode,"Sales",ledgerProductName)+ledgerProductCode;     
    break;		
case "Gross Interest Income":
  accountNumber= "03"+recentAccountMaster("3010000" ,"3019999","03",ledgerProductCode,"Gross Interest Income",ledgerProductName)+ledgerProductCode;     
    break;		
case "Gross Receipt Of Profession Fees":
     accountNumber= "03"+recentAccountMaster("3020000" ,"3029999","03",ledgerProductCode,"Gross Receipt Of Profession Fees",ledgerProductName)+ledgerProductCode;    
    
    break;		
case "Gross Receipt Of Consultancy Fees":
      accountNumber= "03"+recentAccountMaster("3030000" ,"3039999","03",ledgerProductCode,"Gross Receipt Of Consultancy Fees",ledgerProductName)+ledgerProductCode; 
    
    break;		
case "Ledger Fee":
    
      accountNumber= "03"+recentAccountMaster("3040000" ,"3049999","03",ledgerProductCode,"Ledger Fee",ledgerProductName)+ledgerProductCode; 
    break;		
case "Savings Withdraw Charges":
       accountNumber= "03"+recentAccountMaster("3050000" ,"3059999","03",ledgerProductCode,"Savings Withdraw Charges",ledgerProductName)+ledgerProductCode;  
    break;		
case "Dividends":
        accountNumber= "03"+recentAccountMaster("3060000" ,"3069999","03",ledgerProductCode,"Dividends",ledgerProductName)+ledgerProductCode;  
    break;		
case "Admin Costs":
    
        accountNumber= "03"+recentAccountMaster("3070000" ,"3079999","03",ledgerProductCode,"Admin Costs",ledgerProductName)+ledgerProductCode;  
    break;		
case "Charges":
      accountNumber= "03"+recentAccountMaster("3080000" ,"3089999","03",ledgerProductCode,"Charges",ledgerProductName)+ledgerProductCode;   
    
    break;		
case "Membership Fees":
   accountNumber= "03"+recentAccountMaster("3090000" ,"3099999","03",ledgerProductCode,"Membership Fees",ledgerProductName)+ledgerProductCode;     
    break;		
case "Loan Insurance Charges":
   accountNumber= "03"+recentAccountMaster("3100000" ,"3109999","03",ledgerProductCode,"Loan Insurance Charges",ledgerProductName)+ledgerProductCode;     
    break;		
case "Accumulated Interest Income":
    accountNumber= "03"+recentAccountMaster("3110000" ,"3119999","03",ledgerProductCode,"Accumulated Interest Income",ledgerProductName)+ledgerProductCode;   
    
    break;		
case "Loan Surcharge":
    
       accountNumber= "03"+recentAccountMaster("3120000" ,"3129999","03",ledgerProductCode,"Loan Surcharge",ledgerProductName)+ledgerProductCode;   break;		
case "Commission And Fees":
    
         accountNumber= "03"+recentAccountMaster("3130000" ,"3139999","03",ledgerProductCode,"Commission And Fees",ledgerProductName)+ledgerProductCode;  
    break;		
case "Realized Exchange Gain":
    accountNumber= "03"+recentAccountMaster("3140000" ,"3149999","04",ledgerProductCode,"Realized Exchange Gain",ledgerProductName)+ledgerProductCode;  
    break;		
case "Loan Processing Fees":
  accountNumber= "03"+recentAccountMaster("3150000" ,"3159999","03",ledgerProductCode,"Loan Processing Fees",ledgerProductName)+ledgerProductCode;     
    break;
...
//    break;
  ...
  accountNumber= "03"+recentAccountMaster("3160000" ,"3169999","03",ledgerProductCode,"Annual Subscription Fees",ledgerProductName)+ledgerProductCode;    
    
    break;
    
case "Provision For Bad And Doubtful Debts":
    
    accountNumber= "03"+recentAccountMaster("3170000" ,"3179999","03",ledgerProductCode,"Provision For Bad And Doubtful Debts",ledgerProductName)+ledgerProductCode;       
    break;		
case "Bad Debts Recovered":
  accountNumber= "03"+recentAccountMaster("3180000" ,"3189999","03",ledgerProductCode,"Bad Debts Recovered",ledgerProductName)+ledgerProductCode;   
    break;		
case "Gross Amount Received":
     accountNumber= "03"+recentAccountMaster("3190000" ,"3199999","03",ledgerProductCode,"Gross Amount Received",ledgerProductName)+ledgerProductCode;       
    
    break;		
case "Amount Recovered":
    accountNumber= "03"+recentAccountMaster("3200000" ,"3209999","03",ledgerProductCode,"Amount Recovered",ledgerProductName)+ledgerProductCode;       
    
    break;		
case "Reserve For Unexpired Risk Brought From Previous Year Of Income":
   accountNumber= "03"+recentAccountMaster("3210000" ,"3219999","03",ledgerProductCode,"Reserve For Unexpired Risk Brought From Previous Year Of Income",ledgerProductName)+ledgerProductCode;    
    break;		
case "Other Purely Short Term Insurance Income":
    accountNumber= "03"+recentAccountMaster("3220000" ,"3229999","03",ledgerProductCode,"Other Purely Short Term Insurance Income",ledgerProductName)+ledgerProductCode; 
    break;		
case "Any Other Income":
      accountNumber= "03"+recentAccountMaster("3230000" ,"3239999","03",ledgerProductCode,"Any Other Income",ledgerProductName)+ledgerProductCode; 
    
    break;
    case "Savings Penalties":
      accountNumber= "03"+recentAccountMaster("3240000" ,"3249999","03",ledgerProductCode,"Savings Penalties",ledgerProductName)+ledgerProductCode; 
    
    break;
    case "Other Incomes":
      accountNumber= "03"+recentAccountMaster("3250000" ,"3259999","03",ledgerProductCode,"Other Incomes",ledgerProductName)+ledgerProductCode; 
    
    break;
    
    
case "Issued, Subscribed And Paid Up Capital":
  accountNumber= "04"+recentAccountMaster("4000000" ,"4009999","04",ledgerProductCode,"Issued, Subscribed And Paid Up Capital",ledgerProductName)+ledgerProductCode;   
    break;		
case "Additional Issued Share Capital":
 accountNumber= "04"+recentAccountMaster("4010000" ,"4019999","04",ledgerProductCode,"Additional Issued Share Capital",ledgerProductName)+ledgerProductCode;   
    break;		
case "Share Premium":
  accountNumber= "04"+recentAccountMaster("4020000" ,"4029999","04",ledgerProductCode,"Share Premium",ledgerProductName)+ledgerProductCode;  
    
    break;		
case "Capital Reserve":
 accountNumber= "04"+recentAccountMaster("4030000" ,"4039999","04",ledgerProductCode,"Capital Reserve",ledgerProductName)+ledgerProductCode;      
    break;		
case "National Education Fund 2%":
   accountNumber= "04"+recentAccountMaster("4040000" ,"4049999","04",ledgerProductCode,"National Education Fund 2%",ledgerProductName)+ledgerProductCode;    
    break;		
case "Statutory Reserve Fund 10%":
    accountNumber= "04"+recentAccountMaster("4050000" ,"4059999","04",ledgerProductCode,"Statutory Reserve Fund 10%",ledgerProductName)+ledgerProductCode;     
    break;		
case "Revaluation Reserve":
    
     accountNumber= "04"+recentAccountMaster("4060000" ,"4069999","04",ledgerProductCode,"Revaluation Reserve",ledgerProductName)+ledgerProductCode;  
    break;		
case "Co-Operative Development Fund":
      accountNumber= "04"+recentAccountMaster("4070000" ,"4079999","04",ledgerProductCode,"Co-Operative Development Fund",ledgerProductName)+ledgerProductCode;   
    
    break;		
case "Retained Earnings":
      accountNumber= "04"+recentAccountMaster("4080000" ,"4089999","04",ledgerProductCode,"Retained Earnings",ledgerProductName)+ledgerProductCode;    
    
    
    break;		
case "Accumulated Profit Or Loss Or Surplus Or Deficit":
  accountNumber= "04"+recentAccountMaster("4090000" ,"4099999","04",ledgerProductCode,"Accumulated Profit Or Loss Or Surplus Or Deficit",ledgerProductName)+ledgerProductCode;    
    
    break;		
case "General Reserve":
   accountNumber= "04"+recentAccountMaster("4100000" ,"4109999","04",ledgerProductCode,"General Reserve",ledgerProductName)+ledgerProductCode;   
    break;
        ...
        accountNumber= "02"+recentAccountMaster("2000000" ,"2009999","02",ledgerProductCode,"Opening Stock Of Raw Materials",ledgerProductName)+ledgerProductCode;                 
                    
                    break;		
              case "Opening Stock Of Work In Progress":
             accountNumber= "02"+recentAccountMaster("2010000" ,"2019999","02",ledgerProductCode,"Opening Stock Of Work In Progress",ledgerProductName)+ledgerProductCode;       
                  break;		
           case "Opening Stock Of Trading Goods":
     accountNumber= "02"+recentAccountMaster("2020000" ,"2029999","02",ledgerProductCode,"Opening Stock Of Trading Goods",ledgerProductName)+ledgerProductCode;                
               break;		
         case "Opening Stock Of Manufactured Goods":
     accountNumber= "02"+recentAccountMaster("2030000" ,"2039999","02",ledgerProductCode,"Opening Stock Of Manufactured Goods",ledgerProductName)+ledgerProductCode;            
             break;		
       case "Local Purchases Net Of Duties And Taxes":
       accountNumber= "02"+recentAccountMaster("2040000" ,"2049999","02",ledgerProductCode,"Local Purchases Net Of Duties And Taxes",ledgerProductName)+ledgerProductCode;    
           break;		
        case "Imports CIF Value And Taxes":
      accountNumber= "02"+recentAccountMaster("2050000" ,"2059999","02",ledgerProductCode,"Imports CIF Value And Taxes",ledgerProductName)+ledgerProductCode;          
            
            break;		
       case "Direct Wages":
   accountNumber= "02"+recentAccountMaster("2060000" ,"2069999","02",ledgerProductCode,"Direct Wages",ledgerProductName)+ledgerProductCode;            
           break;		
        case "Interest Expenses":
   accountNumber= "02"+recentAccountMaster("2070000" ,"2079999","02",ledgerProductCode,"Interest Expenses",ledgerProductName)+ledgerProductCode;          
            break;		
      case "Direct Expenses":
    accountNumber= "02"+recentAccountMaster("2080000" ,"2089999","02",ledgerProductCode,"Direct Expenses",ledgerProductName)+ledgerProductCode;       
          break;		
       case "Factory Rent":
  accountNumber= "02"+recentAccountMaster("2090000" ,"2099999","02",ledgerProductCode,"Factory Rent",ledgerProductName)+ledgerProductCode;           
           break;		
      case "Factory Rates":
     accountNumber= "02"+recentAccountMaster("2100000" ,"2109999","02",ledgerProductCode,"Factory Rates",ledgerProductName)+ledgerProductCode;          
          break;		
     case "Fuel And Power":
      accountNumber= "02"+recentAccountMaster("2110000" ,"2119999","02",ledgerProductCode,"Fuel And Power",ledgerProductName)+ledgerProductCode;     
         
         break;		
               case "Indirect Wages":
          accountNumber= "02"+recentAccountMaster("2120000" ,"2129999","02",ledgerProductCode,"Indirect Wages",ledgerProductName)+ledgerProductCode;              
                   
                   break;		
               case "Consumables":
       accountNumber= "02"+recentAccountMaster("2130000" ,"2139999","02",ledgerProductCode,"Consumables",ledgerProductName)+ledgerProductCode;               
                   break;		
               case "Depreciation":
        accountNumber= "02"+recentAccountMaster("2140000" ,"2149999","02",ledgerProductCode,"Depreciation",ledgerProductName)+ledgerProductCode;            
                   
                   break;		
               case "Other Factory Overheads":
           accountNumber= "02"+recentAccountMaster("2150000" ,"2159999","02",ledgerProductCode,"Other Factory Overheads",ledgerProductName)+ledgerProductCode;          
                   break;		
               case "Closing Stock Of Raw Materials":
         accountNumber= "02"+recentAccountMaster("2160000" ,"2169999","02",ledgerProductCode,"Closing Stock Of Raw Materials",ledgerProductName)+ledgerProductCode;            
                   break;		
               case "Closing Stock Of Work In Progress":
   accountNumber= "02"+recentAccountMaster("2170000" ,"2179999","02",ledgerProductCode,"Closing Stock Of Work In Progress",ledgerProductName)+ledgerProductCode;                
                   break;		
               case "Closing Stock Of Manufactured Goods":
     accountNumber= "02"+recentAccountMaster("2180000" ,"2189999","02",ledgerProductCode,"Closing Stock Of Manufactured Goods",ledgerProductName)+ledgerProductCode;                
                   
                   break;		
               case "Closing Stock Of Trading Goods":
          accountNumber= "02"+recentAccountMaster("2190000" ,"2199999","02",ledgerProductCode,"Closing Stock Of Trading Goods",ledgerProductName)+ledgerProductCode;             
                   break;		
     case "Advertisement Expense":
             accountNumber= "02"+recentAccountMaster("2200000" ,"2209999","02",ledgerProductCode,"Advertisement Expense",ledgerProductName)+ledgerProductCode;       
         break;		
     case "Audit Expenses":
             accountNumber= "02"+recentAccountMaster("2210000" ,"2219999","02",ledgerProductCode,"Audit Expenses",ledgerProductName)+ledgerProductCode;    
         break;		
     case "Bad Debts Written Off":
        accountNumber= "02"+recentAccountMaster("2220000" ,"2229999","02",ledgerProductCode,"Bad Debts Written Off",ledgerProductName)+ledgerProductCode;          
         break;		
     case "Commission":
         accountNumber= "02"+recentAccountMaster("2230000" ,"2239999","02",ledgerProductCode,"Commission",ledgerProductName)+ledgerProductCode;   
         
         break;		
     case "Computer Soft And Hardware Expenses":
         
        accountNumber= "02"+recentAccountMaster("2240000" ,"2249999","02",ledgerProductCode,"Computer Soft And Hardware Expenses",ledgerProductName)+ledgerProductCode;     
         
         break;		
     case "Maintainance of Office Equipment":
        accountNumber= "02"+recentAccountMaster("2250000" ,"2259999","02",ledgerProductCode,"Maintainance of Office Equipment",ledgerProductName)+ledgerProductCode;    
         
         break;		
     case "News Papers And Periodicals":
         
      accountNumber= "02"+recentAccountMaster("2260000" ,"2269999","02",ledgerProductCode,"News Papers And Periodicals",ledgerProductName)+ledgerProductCode;    
         break;		
     case "Donations":
         accountNumber= "02"+recentAccountMaster("2270000" ,"2279999","02",ledgerProductCode,"Donations",ledgerProductName)+ledgerProductCode;       
         
         break;	
     case "Entertainment And Refreshments":
         accountNumber= "02"+recentAccountMaster("2280000" ,"2289999","02",ledgerProductCode,"Entertainment And Refreshments",ledgerProductName)+ledgerProductCode;   
         break;		
     case "Freight And Transport":
         
           accountNumber= "02"+recentAccountMaster("2290000" ,"2299999","02",ledgerProductCode,"Freight And Transport",ledgerProductName)+ledgerProductCode;   
         break;		
     case "Air Time Allowance":
      accountNumber= "02"+recentAccountMaster("2300000" ,"2309999","02",ledgerProductCode,"Air Time Allowance",ledgerProductName)+ledgerProductCode;      
         
         break;		
     case "Hotel, Boarding And Lodging Expenses":
         
        accountNumber= "02"+recentAccountMaster("2310000" ,"2319999","02",ledgerProductCode,"Hotel, Boarding And Lodging Expenses",ledgerProductName)+ledgerProductCode;     
         
         break;		
     case "Legal Expenses":
         
       accountNumber= "02"+recentAccountMaster("2320000" ,"2329999","02",ledgerProductCode,"Legal Expenses",ledgerProductName)+ledgerProductCode;     
         break;		
     case "Fuel":
            accountNumber= "02"+recentAccountMaster("2330000" ,"2339999","02",ledgerProductCode,"Fuel",ledgerProductName)+ledgerProductCode;     
         
         break;		
     case "Utilities Expenses":
         
             accountNumber= "02"+recentAccountMaster("2340000" ,"2349999","02",ledgerProductCode,"Utilities Expenses",ledgerProductName)+ledgerProductCode; 
         
         break;		
     case "Provision For Bad And Doubtful Debts Expense":
         
         accountNumber= "02"+recentAccountMaster("2350000" ,"2359999","02",ledgerProductCode,"Provision For Bad And Doubtful Debts Expense",ledgerProductName)+ledgerProductCode;   
         
         break;		
     case "Rent Expense":
         
        accountNumber= "02"+recentAccountMaster("2360000" ,"2369999","02",ledgerProductCode,"Rent Expense",ledgerProductName)+ledgerProductCode;    
         break;		
     case "Bad Debts Expense":
         accountNumber= "02"+recentAccountMaster("2370000" ,"2379999","02",ledgerProductCode,"Bad Debts Expense",ledgerProductName)+ledgerProductCode;    
         
         break;		
     case "Car Maintainance And Repairs":
     accountNumber= "02"+recentAccountMaster("2380000" ,"2389999","02",ledgerProductCode,"Car Maintainance And Repairs",ledgerProductName)+ledgerProductCode;       
         
         break;		
     case "Provision for Depreciation":
        accountNumber= "02"+recentAccountMaster("2390000" ,"2399999","02",ledgerProductCode,"Provision for Depreciation",ledgerProductName)+ledgerProductCode;    
         
         break;		
     case "Office Maintainance Expense":
       accountNumber= "02"+recentAccountMaster("2400000" ,"2409999","02",ledgerProductCode,"Office Maintainance Expense",ledgerProductName)+ledgerProductCode;     
         
         break;		
     case "Consultancy":
        accountNumber= "02"+recentAccountMaster("2410000" ,"2419999","02",ledgerProductCode,"Consultancy",ledgerProductName)+ledgerProductCode;   
         
         
         break;		
     case "Loan Recovery Expenses":
          accountNumber= "02"+recentAccountMaster("2420000" ,"2429999","02",ledgerProductCode,"Loan Recovery Expenses",ledgerProductName)+ledgerProductCode;    
     ...
     case "Stationery And Printing":
      ...
      accountNumber= "02"+recentAccountMaster("2430000" ,"2439999","02",ledgerProductCode,"Stationery And Printing",ledgerProductName)+ledgerProductCode;      
         
         break;	
         
     case "Lunch Allowance":
      accountNumber= "02"+recentAccountMaster("2440000" ,"2449999","02",ledgerProductCode,"Lunch Allowance",ledgerProductName)+ledgerProductCode;     
         break;		
     case "Telephone And Internet":
         accountNumber= "02"+recentAccountMaster("2450000" ,"2459999","02",ledgerProductCode,"Telephone And Internet",ledgerProductName)+ledgerProductCode;   
         
         break;		
     case "Training Expenditure":
        accountNumber= "02"+recentAccountMaster("2460000" ,"2469999","02",ledgerProductCode,"Training Expenditure",ledgerProductName)+ledgerProductCode;   
         
         
         break;		
     case "Lincenses And Permits":
      accountNumber= "02"+recentAccountMaster("2470000" ,"2479999","02",ledgerProductCode,"Lincenses And Permits",ledgerProductName)+ledgerProductCode;    
         
         break;		
     case "Parking And Security":
         
          accountNumber= "02"+recentAccountMaster("2480000" ,"2489999","02",ledgerProductCode,"Parking And Security",ledgerProductName)+ledgerProductCode;   
         
         break;		
     case "Depreciation Expense":
         
        accountNumber= "02"+recentAccountMaster("2490000" ,"2499999","02",ledgerProductCode,"Depreciation Expense",ledgerProductName)+ledgerProductCode;     
         break;		
     case "Loss On Disposal Of Assets":
      accountNumber= "02"+recentAccountMaster("2500000" ,"2509999","02",ledgerProductCode,"Loss On Disposal Of Assets",ledgerProductName)+ledgerProductCode;     
         
         break;		
     case "Management Fees":
       accountNumber= "02"+recentAccountMaster("2510000" ,"2519999","02",ledgerProductCode,"Management Fees",ledgerProductName)+ledgerProductCode;  
         break;		
     case "AGM Expenses":
         
        accountNumber= "02"+recentAccountMaster("2520000" ,"2529999","02",ledgerProductCode,"AGM Expenses",ledgerProductName)+ledgerProductCode;     
         break;	
         
         
      case "Salaries And Wages":
        accountNumber= "02"+recentAccountMaster("2530000" ,"2539999","02",ledgerProductCode,"Salaries And Wages",ledgerProductName)+ledgerProductCode;      
          
          
          break;		
      case "Bonus":
         accountNumber= "02"+recentAccountMaster("2540000" ,"2549999","02",ledgerProductCode,"Bonus",ledgerProductName)+ledgerProductCode;     
          break;		
      case "PAYEE":
         accountNumber= "02"+recentAccountMaster("2550000" ,"2559999","02",ledgerProductCode,"PAYEE",ledgerProductName)+ledgerProductCode;      
          
          break;		
      case "Board Sitting Allowances":
          
       accountNumber= "02"+recentAccountMaster("2560000" ,"2569999","02",ledgerProductCode,"Board Sitting Allowances",ledgerProductName)+ledgerProductCode;     
          
          break;		
      case "Employee Allowances":
         accountNumber= "02"+recentAccountMaster("2570000" ,"2579999","02",ledgerProductCode,"Employee Allowances",ledgerProductName)+ledgerProductCode;    
          
          break;		
      case "Directors Allowances":
        accountNumber= "02"+recentAccountMaster("2580000" ,"2589999","02",ledgerProductCode,"Directors Allowances",ledgerProductName)+ledgerProductCode;    
          
          break;		
      case "Contribution To Retirement Fund":
         accountNumber= "02"+recentAccountMaster("2590000" ,"2599999","02",ledgerProductCode,"Contribution To Retirement Fund",ledgerProductName)+ledgerProductCode;     
          
          break;
          
      case "Medical Allowance":
                accountNumber= "02"+recentAccountMaster("2600000" ,"2609999","02",ledgerProductCode,"Medical Allowance",ledgerProductName)+ledgerProductCode;  
          
          break;		
      case "NSSF Contributions":
            accountNumber= "02"+recentAccountMaster("2610000" ,"2619999","02",ledgerProductCode,"NSSF Contributions",ledgerProductName)+ledgerProductCode; 
          break;		
    case "Interest Expense":
        accountNumber= "02"+recentAccountMaster("2620000" ,"2629999","02",ledgerProductCode,"Interest Expense",ledgerProductName)+ledgerProductCode;   
        
        break;		
    case "Bank Charges":
         accountNumber= "02"+recentAccountMaster("2630000" ,"2639999","02",ledgerProductCode,"Bank Charges",ledgerProductName)+ledgerProductCode;   
        
        break;	
        
    case "Start Up Expenses":
        accountNumber= "02"+recentAccountMaster("2640000" ,"2649999","02",ledgerProductCode,"Start Up Expenses",ledgerProductName)+ledgerProductCode;    
        
        break;	
        
        
    case "Lending License":
         accountNumber= "02"+recentAccountMaster("2650000" ,"2659999","02",ledgerProductCode,"Lending License",ledgerProductName)+ledgerProductCode;    
        break;		
    case "Company Stamps":
        
         accountNumber= "02"+recentAccountMaster("2660000" ,"2669999","02",ledgerProductCode,"Company Stamps",ledgerProductName)+ledgerProductCode;    
        break;		
    case "Unrealized Exchange Loss":
       accountNumber= "02"+recentAccountMaster("2670000" ,"2679999","02",ledgerProductCode,"Unrealized Exchange Loss",ledgerProductName)+ledgerProductCode;    
        
        break;	
         case "Return On Investment Expense":
       accountNumber= "02"+recentAccountMaster("2770000" ,"2779999","02",ledgerProductCode,"Return On Investment Expense",ledgerProductName)+ledgerProductCode;    
        
        break;	
    case "Claims Admitted During The Year":
     accountNumber= "02"+recentAccountMaster("2680000" ,"2689999","02",ledgerProductCode,"Claims Admitted During The Year",ledgerProductName)+ledgerProductCode;    
        
        break;		
    case "Premiums Returned To Insured":
      accountNumber= "02"+recentAccountMaster("2690000" ,"2699999","02",ledgerProductCode,"Premiums Returned To Insured",ledgerProductName)+ledgerProductCode;       
        
        
        break;		
    case "Reserves For Unexpired Risk Carried Forward":
        
        accountNumber= "02"+recentAccountMaster("2700000" ,"2709999","02",ledgerProductCode,"Reserves For Unexpired Risk Carried Forward",ledgerProductName)+ledgerProductCode;    
        break;		
    case "Agency Expenses":
        
       accountNumber= "02"+recentAccountMaster("2710000" ,"2719999","02",ledgerProductCode,"Agency Expenses",ledgerProductName)+ledgerProductCode;    
        
        break;		
    case "Other Expenses Related To Short Term Business":
      accountNumber= "02"+recentAccountMaster("2720000" ,"2729999","02",ledgerProductCode,"Other Expenses Related To Short Term Business",ledgerProductName)+ledgerProductCode;    
  ...
  case "Income Tax Expense":
       accountNumber= "02"+recentAccountMaster("2730000" ,"2739999","02",ledgerProductCode,"Income Tax Expense",ledgerProductName)+ledgerProductCode;   
      break;		
  case "Dividends paid during the Operating period":
      accountNumber= "02"+recentAccountMaster("2740000" ,"2749999","02",ledgerProductCode,"Dividends paid during the Operating period",ledgerProductName)+ledgerProductCode;     
      
      break;		
  case "Retained earnings at start of Operating period":
  accountNumber= "02"+recentAccountMaster("2750000" ,"2759999","02",ledgerProductCode,"Retained earnings at start of Operating period",ledgerProductName)+ledgerProductCode;     
      
      break;		
  case "General expense":
  accountNumber= "02"+recentAccountMaster("2760000" ,"2769999","02",ledgerProductCode,"General expense",ledgerProductName)+ledgerProductCode;        
...
//      break;
 case "Restatement of retained earnings for changes in accounting policies":
  accountNumber= "02"+recentAccountMaster("2780000" ,"2789999","02",ledgerProductCode,"Restatement of retained earnings for changes in accounting policies",ledgerProductName)+ledgerProductCode;        
      
      break;
    
     case "Compliance And Regulatory Expenses":
  accountNumber= "02"+recentAccountMaster("2790000" ,"2799999","02",ledgerProductCode,"Compliance And Regulatory Expenses",ledgerProductName)+ledgerProductCode;        
      
      break;
      
       case "Festive Allowance":
  accountNumber= "02"+recentAccountMaster("2800000" ,"2809999","02",ledgerProductCode,"Festive Allowance",ledgerProductName)+ledgerProductCode;        
      
      break;
      
       case "Employee Welfare":
  accountNumber= "02"+recentAccountMaster("2810000" ,"2819999","02",ledgerProductCode,"Employee Welfare",ledgerProductName)+ledgerProductCode;        
      
      break;
      
      case "Caveat Charges":
  accountNumber= "02"+recentAccountMaster("2820000" ,"2829999","02",ledgerProductCode,"Caveat Charges",ledgerProductName)+ledgerProductCode;        
      
      break;
      
       case "Loans Committee Expenses":
  accountNumber= "02"+recentAccountMaster("2830000" ,"2839999","02",ledgerProductCode,"Loans Committee Expenses",ledgerProductName)+ledgerProductCode;        
      
      break;
      
       case "Admin Expenses":
  accountNumber= "02"+recentAccountMaster("2840000" ,"2849999","02",ledgerProductCode,"Admin Expenses",ledgerProductName)+ledgerProductCode;        
    ...
    private String recentAccountMaster(String lowerLedgrMasterCode, String upperMasterCode,String accountType,String ledgerProductCode,String accountMasterName,String ledgerProductName){
...
//   fios.stringFileWriter(fios.createFileName("test", "testit", upperMasterCode+"trdyr.txt"),ledgerMasterCode+"");      
    ...
    if(!testTable("BSANCA"+accountType+lowerLedgrMasterCode+ledgerProductCode)){
     ...
     createMaterAccount(accountType+lowerLedgrMasterCode+ledgerProductCode, accountMasterName); 
...
public synchronized void createMaterAccount(String accountNumber, String accountName){
