...
public class SendSms extends UrlEncodeingDecoding {
       ...
       DatabaseQuaries dbq =new DatabaseQuaries();
        ...
        public synchronized void createDisbursementPaymentSMS(String accountNumber,String amount){
...
dbq.updateCreatedMessage(createMessage(smsDetails,amount,"LoanDisbursement",id,accountNumber),id);
...
dbq.updateCreatedMessageInsufficient(createMessage(smsDetails,amount,"LoanDisbursement",id,accountNumber),id);
...
public synchronized void createSharesPaymentSMS(String accountNumber,String amount){
...
dbq.updateCreatedMessage(createMessage(smsDetails,amount,"SharesPayment",id,accountNumber),id);
...
dbq.updateCreatedMessageInsufficient(createMessage(smsDetails,amount,"SharesPayment",id,accountNumber),id);
    ...
    public synchronized void createLoanPaymentSMS(String accountNumber,String amount){
...
dbq.updateCreatedMessage(createMessage(smsDetails,amount,"LoanPayment",id,accountNumber),id);
...
dbq.updateCreatedMessageInsufficient(createMessage(smsDetails,amount,"LoanPayment",id,accountNumber),id);
...
public synchronized void createSavingsSMS(String accountNumber,String amount){
...
dbq.updateCreatedMessage(createMessage(smsDetails,amount,"Savings",id,accountNumber),id);
...
dbq.updateCreatedMessageInsufficient(createMessage(smsDetails,amount,"Savings",id,accountNumber),id);
...
public synchronized void createwithdrawTransacttSMS(String accountNumber,String amount){
...
dbq.updateCreatedMessage(createMessage(smsDetails,amount,"withdrawFromAccount",id,accountNumber),id);
...
dbq.updateCreatedMessageInsufficient(createMessage(smsDetails,amount,"withdrawFromAccount",id,accountNumber),id);
...
public synchronized void createLoanApliedSMS(String accountNumber,String amount){
...
dbq.updateCreatedMessage(createMessage(smsDetails,amount,"LoanApplied",id,accountNumber),id);
...
dbq.updateCreatedMessageInsufficient(createMessage(smsDetails,amount,"LoanApplied",id,accountNumber),id);
...
public synchronized void createLoanApprovedSMS(String accountNumber,String amount){
...
dbq.updateCreatedMessage(createMessage(smsDetails,amount,"LoanApproved",id,accountNumber),id);
...
dbq.updateCreatedMessageInsufficient(createMessage(smsDetails,amount,"LoanApproved",id,accountNumber),id);
...
public synchronized void createLoanDeclinedSMS(String accountNumber,String amount){
...
dbq.updateCreatedMessage(createMessage(smsDetails,amount,"LoanDeclined",id,accountNumber),id);
...
dbq.updateCreatedMessageInsufficient(createMessage(smsDetails,amount,"LoanDeclined",id,accountNumber),id);
...
public synchronized void createSmsTomorrowLoanReminder(String accountNumber,String amount){
...
dbq.updateCreatedMessage(createMessage(smsDetails,amount,"LoanReminderTomorrowPayment",id,accountNumber),id);
...
dbq.updateCreatedMessageInsufficient(createMessage(smsDetails,amount,"LoanReminderTomorrowPayment",id,accountNumber),id);
...
public synchronized void createSmsTodayLoanReminder(String accountNumber,String amount){
...
dbq.updateCreatedMessage(createMessage(smsDetails,amount,"LoanReminderTodayPayment",id,accountNumber),id);
...
dbq.updateCreatedMessageInsufficient(createMessage(smsDetails,amount,"LoanReminderTodayPayment",id,accountNumber),id);
...
public synchronized void createSmsArrearsLoanReminder(String accountNumber,String amount){
...
dbq.updateCreatedMessage(createMessage(smsDetails,amount,"LoanReminderArrearsPayment",id,accountNumber),id);
...
dbq.updateCreatedMessageInsufficient(createMessage(smsDetails,amount,"LoanReminderArrearsPayment",id,accountNumber),id);

}


}
public synchronized void createSmsAccountCreation(String accountNumber,String amount){
...
dbq.updateCreatedMessage(createMessage(smsDetails,amount,"accountCreatedMember",id,accountNumber),id);
...
dbq.updateCreatedMessageInsufficient(createMessage(smsDetails,amount,"accountCreatedMember",id,accountNumber),id);
...
private List createMessage(List messageParamenters,String amountInvolved,String messageType,int dataBaseId,String accountNumber){
...
for(int x=0;x<5;x++){
    ...
    fios.stringFileWriterAppend(fios.createFileName("emailDetails", "sms", "message"+dataBaseId+".txt"), ":");
     ...
     case "accountCreatedMember":
       ...
       if(fios.intFileReader(fios.createFileName("emailDetails", "boxNumber", "AllNumbers.txt"))==7){
       if(!messageParamenters.get(2).toString().isEmpty()){
        mynumbersAC="256"+messageParamenters.get(2).toString().substring(1, 10);
       }else{
       ...
       mynumbersAC="256782231039";
          ...
          MessageAC="Dear"+"%20"+nameAC+"%2C"+"%0A"+"%20"+entityAC+"%20"+"has"+"%20"+"created"+"%20"+"your"+"%20"+"transaction"+"%20"+"account"+"%20"+"AccountNumber"+"%3A"+accountNumber+"%20"+"AccountName"+"%3A"+userName+"%2E"+"%20"+"Contact"+"%20"+"management"+"%20"+"for"+"%20"+"more"+"%20"+"information"+"%2E";
