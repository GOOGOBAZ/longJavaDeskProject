...
return updated;
   ...
   public void processSmsRemindersForLoanPaymentTomorrow(){
   ...
   sendsms.createSmsTomorrowLoanReminder(theItems.get(0).toString(), theItems.get(1).toString());
...
//   JOptionPane.showMessageDialog(c, LastDepreciationNumber);
     ...
     postinAccrualsn. processDepreciationF(theAccount.toString(),amount, c);
       ...
       public void processSmsRemindersForLoanPaymentToday(){
  ...
  if(!theItemsForReminder.isEmpty()){
   ...
   sendsms.createSmsTodayLoanReminder(theItems.get(0).toString(), theItems.get(1).toString());
        ...
        public void processSmsRemindersForLoanPaymentArrears(){
