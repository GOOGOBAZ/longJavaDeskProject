...
if(loanS.createRunningLoanStatement(accountNumber.toString(),"LoanStatement"+dbq.AccountName(accountNumber.toString()))){
            attachements.add(fios.createFileName("PMMS_Statements", "PMMS_Statements1", "LoanStatement"+dbq.AccountName(accountNumber.toString())+".pdf"));   
             ...
             break; 
                 ...
                 case "ProfitAndLoss":
if(PAndL.createPAndL(form.forDatabaseWithFullYearBeginningWithDate(report.get(1).toString()),form.forDatabaseWithFullYearBeginningWithDate(report.get(2).toString()), "ProfitAndLossStatement")){
            attachements.add(fios.createFileName("PMMS_Statements", "PMMS_Statements1", "ProfitAndLossStatement.pdf"));   
          }       
             
             break; 
                 case "BalanceSheet":
if(balSheet.createBalanceSheet(form.forDatabaseWithFullYearBeginningWithDate(report.get(2).toString()), "BalanceSheetStatement")){
